...
#/api/v1/orderget
resource "aws_api_gateway_resource" "api_rsc_03_00" {
  parent_id   = aws_api_gateway_resource.api_rsc_02.id
  path_part   = "orderget"
  rest_api_id = aws_api_gateway_rest_api.api.id
}
#/api/v1/orderget/{userId}
resource "aws_api_gateway_resource" "api_rsc_03_01" {
  parent_id   = aws_api_gateway_resource.api_rsc_03_00.id
  path_part   = "{userId}"
  rest_api_id = aws_api_gateway_rest_api.api.id
}
#/api/v1/orderget/{userId}/{orderId}
resource "aws_api_gateway_resource" "api_rsc_03_02" {
  parent_id   = aws_api_gateway_resource.api_rsc_03_01.id
  path_part   = "{orderId}"
  rest_api_id = aws_api_gateway_rest_api.api.id
}

#/api/v1/orderget/{userId}/{orderId}/GET
resource "aws_api_gateway_method" "api_mthd_04" {
  authorization = "NONE"
  http_method   = "GET"
  resource_id   = aws_api_gateway_resource.api_rsc_03_02.id
  rest_api_id   = aws_api_gateway_rest_api.api.id
}
...
#/api/v1/orderlist/{userId}
resource "aws_api_gateway_resource" "api_rsc_07_02" {
  parent_id   = aws_api_gateway_resource.api_rsc_07_00.id
  path_part   = "{userId}"
  rest_api_id = aws_api_gateway_rest_api.api.id
}

#/api/v1/orderlist/{userId}/GET
resource "aws_api_gateway_method" "api_mthd_07" {
  authorization = "NONE"
  http_method   = "GET"
  resource_id   = aws_api_gateway_resource.api_rsc_07_02.id
  rest_api_id   = aws_api_gateway_rest_api.api.id
}
resource "aws_api_gateway_integration" "api_mthd_07" {
  rest_api_id             = aws_api_gateway_rest_api.api.id
  resource_id             = aws_api_gateway_resource.api_rsc_07_02.id
  http_method             = aws_api_gateway_method.api_mthd_07.http_method
  type                    = "AWS" #"AWS_PROXY"
  passthrough_behavior    = "WHEN_NO_TEMPLATES"
  integration_http_method = "POST"
...
resource "aws_api_gateway_integration_response" "api_mthd_07" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.api_rsc_07_02.id
  http_method = aws_api_gateway_method.api_mthd_07.http_method
  status_code = aws_api_gateway_method_response.api_mthd_04.status_code
...
resource "aws_api_gateway_method_response" "api_mthd_07" {
  rest_api_id     = aws_api_gateway_rest_api.api.id
  resource_id     = aws_api_gateway_resource.api_rsc_07_02.id
  http_method     = aws_api_gateway_method.api_mthd_07.http_method
  status_code     = "200"
...
#.....................................
#/api/v1/orderlist/{userId}/OPTIONS

resource "aws_api_gateway_method" "api_mthd_08" {
  authorization = "NONE"
  http_method   = "OPTIONS"
  resource_id   = aws_api_gateway_resource.api_rsc_07_02.id
  rest_api_id   = aws_api_gateway_rest_api.api.id
}
resource "aws_api_gateway_integration" "api_mthd_08" {
  rest_api_id             = aws_api_gateway_rest_api.api.id
  resource_id             = aws_api_gateway_resource.api_rsc_07_02.id
  http_method             = aws_api_gateway_method.api_mthd_08.http_method
  timeout_milliseconds    = 29000
  type                    = "MOCK"
  passthrough_behavior    = "WHEN_NO_TEMPLATES"
}
resource "aws_api_gateway_method_response" "api_mthd_08" {
  rest_api_id         = aws_api_gateway_rest_api.api.id
  resource_id         = aws_api_gateway_resource.api_rsc_07_02.id
  http_method         = aws_api_gateway_method.api_mthd_08.http_method
  status_code         = "200"
...
resource "aws_api_gateway_integration_response" "api_mthd_08" {
  rest_api_id         = aws_api_gateway_rest_api.api.id
  resource_id         = aws_api_gateway_resource.api_rsc_07_02.id
  http_method         = aws_api_gateway_method.api_mthd_08.http_method
  status_code         = aws_api_gateway_method_response.api_mthd_08.status_code
  response_parameters = { 
    "method.response.header.Access-Control-Allow-Headers" = "'pregma, cache-control, expires'"
    "method.response.header.Access-Control-Allow-Methods" = "'DELETE, GET, HEAD, PATCH, PUT, POST,OPTIONS'",
    "method.response.header.Access-Control-Allow-Origin" = "'*'"
...
resource "aws_api_gateway_resource" "api_rsc_05" {
  parent_id   = aws_api_gateway_resource.api_rsc_02.id
  path_part   = "orderupdate"
  rest_api_id = aws_api_gateway_rest_api.api.id
}

#/api/v1/orderupdate/POST
...
resource "aws_lambda_permission" "lambda_permission_02" {
  ...
  principal     = "apigateway.amazonaws.com"
  source_arn    = "arn:aws:execute-api:${data.aws_region.aws-region.name}:${data.aws_caller_identity.current.account_id}:${aws_api_gateway_rest_api.api.id}/*/${aws_api_gateway_method.api_mthd_04.http_method}${aws_api_gateway_resource.api_rsc_03_02.path}"
}
...
resource "aws_lambda_permission" "lambda_permission_03" {
  ...
  principal     = "apigateway.amazonaws.com"
  source_arn    = "arn:aws:execute-api:${data.aws_region.aws-region.name}:${data.aws_caller_identity.current.account_id}:${aws_api_gateway_rest_api.api.id}/*/${aws_api_gateway_method.api_mthd_07.http_method}${aws_api_gateway_resource.api_rsc_07_02.path}"
}
#Lambda permission 04
resource "aws_lambda_permission" "lambda_permission_04" {
  statement_id  = "AllowExecutionFromApi04"
  action        = "lambda:InvokeFunction"
